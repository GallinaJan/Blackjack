...
private:
    ...
    Cards default_tab_[52] = {
            ...
            Cards("krol", "kier", 10, 4),
            Cards("krol", "karo", 10, 5),
            Cards("krol", "pik", 10, 6),
            Cards("krol", "trefl", 10, 7),

            Cards("dama", "kier", 10, 8),
            Cards("dama", "karo", 10, 9),
            Cards("dama", "pik", 10, 10),
            Cards("dama", "trefl", 10, 11),

            Cards("walet", "kier", 10, 12),
            Cards("walet", "karo", 10, 13),
            Cards("walet", "pik", 10, 14),
            Cards("walet", "trefl", 10, 15),

            Cards("10", "kier", 10, 16),
            Cards("10", "karo", 10, 17),
            Cards("10", "pik", 10, 18),
            Cards("10", "trefl", 10, 19),
